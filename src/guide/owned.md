...
External or deployment-specific wire encodings, registered wire identities, native-prefix
...
`UWireTransport` (exposed by `transport-implementer-api`) compose the encoding above you
...
Shared obligations: the transport hub. Which
