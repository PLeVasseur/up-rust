...
// These public fields mirror the fixture protos one-to-one; documenting each
// field again would obscure that contract rather than clarify it.
#![expect(
    missing_docs,
    reason = "fixed-layout benchmark schema mirrors fixture protos"
)]

use crate::StablePayloadInit;
...
#[repr(C)]
#[derive(Clone, Copy, Debug, crate::StablePayload, crate::StablePayloadInit)]
...
#[repr(C)]
#[derive(Debug, crate::StablePayload, crate::StablePayloadInit)]
...
pub type CanClassicFrameV1Init<'a> = <CanClassicFrameV1 as StablePayloadInit>::Initializer<'a>;
pub type CanFdFrameV1Init<'a> = <CanFdFrameV1 as StablePayloadInit>::Initializer<'a>;
pub type SomeIpSignalBatchMtuV1Init<'a> =
    <SomeIpSignalBatchMtuV1 as StablePayloadInit>::Initializer<'a>;
pub type StreamChunk4kV1Init<'a> = <StreamChunk4kV1 as StablePayloadInit>::Initializer<'a>;
pub type RadarDetectionListArs548V1Init<'a> =
    <RadarDetectionListArs548V1 as StablePayloadInit>::Initializer<'a>;
pub type StreamChunk64kV1Init<'a> = <StreamChunk64kV1 as StablePayloadInit>::Initializer<'a>;

#[cfg(feature = "payload-contract-large-fixtures")]
pub type LidarPointCloudHesaiAt128V1Init<'a> =
    <LidarPointCloudHesaiAt128V1 as StablePayloadInit>::Initializer<'a>;
#[cfg(feature = "payload-contract-large-fixtures")]
pub type CameraBayerRggb12pFrame8mpV1Init<'a> =
    <CameraBayerRggb12pFrame8mpV1 as StablePayloadInit>::Initializer<'a>;
