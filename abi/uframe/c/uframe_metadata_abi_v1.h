 ...
 *   6 raw, 7 text, 8 shm.
 * 9..=0x0FFFFFFF: future registered encodings. 0x10000000..: private use. */
...
typedef struct uframe_payload_encoding_abi {
    uint32_t registry_id; /* valid iff FIELD_PAYLOAD_ENCODING is set */
} uframe_payload_encoding_abi; /* size 4, align 4 */
...
static_assert(sizeof(uframe_payload_encoding_abi) == 4, "encoding size");
...
static_assert(offsetof(uframe_metadata_abi_v1, source) == 76, "source offset");
static_assert(offsetof(uframe_metadata_abi_v1, sink) == 212, "sink offset");
static_assert(offsetof(uframe_metadata_abi_v1, traceparent) == 348, "traceparent offset");
static_assert(offsetof(uframe_metadata_abi_v1, token) == 412, "token offset");
static_assert(offsetof(uframe_metadata_abi_v1, reserved_tail) == 924, "reserved_tail offset");
