...
|---|---|---|
| `WIRE-FORMAT.md` | **Normative** byte contracts: metadata field block v1, `UPFE` whole-frame envelope, kind/priority/presence/encoding registries | round-trip unit tests in `up-rust` (`frame_codec`, `frame_wire`) |
