...
//! `uprotocol.v2.UFrameMetadataAbiV1`, size 928, alignment 8.
...
const _: () = {
    ...
    assert!(size_of::<UPayloadEncodingAbi>() == 4 && align_of::<UPayloadEncodingAbi>() == 4);
    ...
    assert!(offset_of!(UFrameMetadataAbiV1, reserved_tail) == 924);
